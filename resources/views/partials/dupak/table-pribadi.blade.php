        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-sm font-medium space-x-2">
                    <a href="{{ route('dupak.pengajuan.show', $item->id) }}" class="text-blue-600 hover:underline">Lihat</a>

                    @if (!$user->is_admin && in_array($item->status, ['Draft','Revisi']))
                    <a href="{{ route('dupak.pengajuan.edit', $item->id) }}" class="text-indigo-600 hover:underline">Edit</a>
                    ...
                    <a href="{{ route('dupak.validasi.show', $item->id) }}" class="text-green-600 hover:underline">Validasi</a>
                    @endif
                </td>
