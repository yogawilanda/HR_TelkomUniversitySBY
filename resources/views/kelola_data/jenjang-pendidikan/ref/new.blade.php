        ...
        <div class="flex w-full flex-col gap-[2.94px] grow">
            <div class="flex items-center gap-[5.87px] self-stretch">
                <span class="font-medium text-2xl leading-[20.56px] text-[#101828]">
                    Tambah Referensi Jenjang Pendidikan Baru
                </span>
            </div>
        </div>
    </div>
...
@section('content-base')
    <x-form route="{{ route('manage.jenjang-pendidikan.ref.store') }}" id="form-jenjang">
        <div class="grid gap-8">
            <div class="flex flex-col gap-4">

                <div class="flex flex-col gap-1">
                    <x-itxt lbl="Kode Jenjang Pendidikan" nm="jenjang_pendidikan" plc="Contoh: S1" max="10"
                        :req="true" />

                </div>

                <div class="flex flex-col gap-1">
                    <x-itxt lbl="Tingkat" nm="tingkat" plc="Contoh: Sarjana" max="100" :req="true" />
                </div>

                <div class="flex flex-col gap-2">
                    <x-itxt lbl="Urutan" type="number" nm="urutan" plc="Masukkan Angka Urutan" :req="true" />
                ...
                <div class="flex flex-col gap-1">
                    <x-itxt lbl="Kode Gelar" nm="kode_gelar" plc="Contoh: S.T." max="20" :req="true" />
