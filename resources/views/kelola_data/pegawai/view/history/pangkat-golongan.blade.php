    ...
    <div class="w-full max-w-3xl mx-auto my-12 font-sans antialiased px-6 text-[#1d1d1f]">
        ...
        <div class="mb-12 pb-6 border-b border-[#e8e8ed]">
            ...
            <p class="text-base text-[#86868b] mt-2">
                Perjalanan garis waktu dan dokumentasi resmi Anda.
            </p>
        </div>
                ...
                @if ($data->is_active)
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 flex-wrap">
                            <!-- Menggabungkan Pangkat dan Golongan dengan pemisah garis miring yang bersih -->
                            <h3 class="text-2xl font-bold tracking-tight text-[#1d1d1f]">
                                {{ $data->refPangkatGolongan->pangkat }} <span class="text-[#86868b] font-normal mx-1">/</span> <span class="text-xl font-semibold text-[#515154]">{{ $data->refPangkatGolongan->golongan }}</span>
                            </h3>
                        ...
                        <div class="flex flex-wrap gap-3 pt-1">
                            @if(isset($data->skLlDikti->no_sk))
                            <a href="{{ route('manage.sk.view', ['id_sk_or_sk_number' => $data->skLlDikti->id]) }}" target="_blank"
                                ...
                                <span>SK DIKTI: {{$data->skLlDikti->no_sk}}</span>
