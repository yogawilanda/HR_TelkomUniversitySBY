        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <!-- Widget : Tambahkan TPAK tanpa  -->
                    <!-- Proses sistem -->
                    <!-- 
                    1. Membuka pop up
                    2. Berikan user 2 pilihan, Tambah dari dosen yang ada, atau tambah pengguna baru 
                    3. Ketika memilih dosen baru : arahkan untuk halaman pembuatan akun baru/dosen baru
                    4. Ketika memilih dosen yang ada : ganti popup dengan popup baru yaitu pilih dosen yang ada.
                    -->
                     <div class="p-6 border rounded-lg bg-white shadow-sm border-l-4 border-l-blue-900">
                        ...
                        <a href="{{ route('dupak.penunjukan_tpak.create_new_tpak') }}" class="px-4 py-2 bg-blue-900 text-white rounded hover:bg-blue-950 text-sm inline-block">
                            Tambahkan TPAK Baru
                        </a>
                    </div>
